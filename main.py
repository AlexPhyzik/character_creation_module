...
def attack(char_name: str, char_class: str) -> str:
    """Calc char attack depends of char class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calc char defence depends of char class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calc char special attack depends of char class."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Take char name and class from input."""
    approve_choice: str = ''
    char_class: str = ''
